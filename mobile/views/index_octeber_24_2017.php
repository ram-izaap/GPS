      ...
      <div class="map-id clearfix">
        ...
        <div class="col-xs-4">
          <div class="pencil-cover">
            <input type="text" placeholder="<?php echo $search_val;?>" value="<?php echo $search_val;?>" class="edit-id text">
...
-->
      ...
      <div class="share-location clearfix">
        <div class="col-xs-12">
          ...
          <a data-toggle="modal" data-target="#searchshare_mb"><i class="fa fa-share-alt"></i>
      ...
      <a href="javascript:void(0);">
        ...
        <div class="col-xs-3">
            <div class="map-button">  
              <span id="invisible_icon" style="display: none;">
              Off <i class="glyphicon glyphicon-eye-close"   aria-hidden="true" onclick="return invisible_participant(<?php echo $user_info['user_id'];?>,<?php echo $group_id;?>,0)"></i>
            </span>
            <span id="visible_icon">
              On <i class="glyphicon glyphicon-eye-open"  onclick="return invisible_participant(<?php echo $user_info['user_id'];?>,<?php echo $group_id;?>,1)"></i>
            </span>
                  <!--
<label class="switch">
                    <input type="checkbox" name="guest_pos_type" value="1" />
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <form action="">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center"><b>Make Visible on Map</b></h4>
      </div>
              ...
              <li>
                <div class="input-group">
                  <div id="radioBtn" class="btn-group">
                    <a class="btn btn-primary btn-sm active" data-toggle="happy" data-title="Y">On</a>
                    <a class="btn btn-primary btn-sm notActive" data-toggle="happy" data-title="N">Off</a>
                  </div>
      ...
      <div class="modal-footer">
        <div class="btn-group" role="group" aria-label="...">
          <button type="button" class="btn btn-default btn-success" data-dismiss="modal">Update</button>
