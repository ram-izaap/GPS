   <?php $search_val  = ($map_search_key)?$map_search_key:get_cookie('map_search'); 
    ...
    <header class="cf"><!-- Header area Start-->
      ...
      <a class="m-logo" href="<?php echo base_url();?>">
        <img src="<?php echo base_url();?>assets/image/logo-new.png" class="img-responsive" alt="header-logo" />
      </a>
       <span>Current Joined <img src="<?php echo base_url();?>assets/image/down-arrow.png" alt="down-arrow" /> Map Channel ID</span>
        ...
        <div class="chn-id">
           <div class="share-iconn">
             ...
             <a href="<?php echo base_url();?>search/<?php echo $rand_channelid; ?>"><img src="<?php echo base_url();?>assets/image/map_me_4.png" class="img-responsive" alt="share-map"></a>
              <a data-toggle="modal" data-target="#mobilechannelshare"><img src="<?php echo base_url();?>assets/image/channel-id.png" class="img-responsive" alt="share-icon" /></a>
                ...
                <div class="input-group updatephone">
                  <input type="text" readonly=""  class="map-id form-control input-ctrl" id="phone" name="phone" value="<?php echo $rand_channelid;?>" />
                     <span class="input-group-addon update-link">
                          <span onclick="create_map('guest_pos_type',<?php echo $usrchk;?>,'.popover-content #guest_address','manual','updatephone');" class="glyphicon glyphicon-ok"></span><br />Update
                      </span>
        ...
        <div class="display-id">
          <div class="">
                <div class="share-iconn">
                    ...
                    <div class=""></div>
                    <div class="input-group arrow_box11 updatedisplayname">
                        ...
                        <span class="input-group-addon update-link">
                          <span onclick="create_map('guest_pos_type',<?php echo $usrchk;?>,'.popover-content #guest_address','manual','updatedisplayname');" class="glyphicon glyphicon-ok"></span><br />Update
                        </span>
                          <span class="input-group-addon edit-icon">
              ...
              <?php $uri = $this->uri->segment(1); 
                ...
                <?php } else if($search_val == $rand_channelid){?>
                    ...
                    <span class="join-map">Map Joined 
                        <button class="close" type="button" onclick="group_user_delete('<?php echo $maps['group_id'];?>', '<?php echo $maps['user_id'];?>','<?php echo $rand_channelid; ?>')">
            ...
            <div class="m-radio m-manuall">
              <div class="radio chk-box-radio">
                <label>
                    ...
                    <input type="radio" id="guest_manual"  value='2' name="guest_pos_type" <?php echo (!empty($manual_address) && ($manual_address=='yes'))?"checked='checked'":""; ?> />
                    <span class="cr my-location" id="popover" data-uid="<?php echo (!empty($user_info['user_id']))?$user_info['user_id']:""; ?>" rel="popover" data-placement="top"><i class="cr-icon fa fa-check"></i></span>
