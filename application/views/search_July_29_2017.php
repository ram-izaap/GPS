       ...
       if(maptype == 'public'){ 
        ...
        for (var i = 0; i < locations.length; i++) {  
          ...
          if(invisible == 1 && staticmap == '') { 
            filters1 += '<li><a href="javascript:posclick('+ i + ')"><div class="p-parti"><span class="name"><b>DN: </b>'+gpus+'</span><br /><span class="name"><b>CHID: </b>'+ctrack+'</span></div></a><div class="p-find-iocn">'+group_admin_icon+invisible_icon+'</div></li>';
          }
