...
<?php if(!empty($mobile_header) && ($mobile_header == 'no')) { ?>
    ...
    <?php }else { ?>
        <div class="google-add right-add200">
        <!-- Google ads -->
    ...
    <?php } ?>
<div class="container"><!-- Content area Start-->

      <div class="top-img">
        <h1>Tell us your Story</h1>
        <h4>Get Upgrade to a pro version of this app</h4>
      </div>
      <section id="carousel" class="content-slider martop">
        <div class="container">
          <div class="row">
            <div class="col-md-12 ">
  ...
  .right-add23 { position:absolute; top:25%; left:0; width:10%; z-index:99999; height:60px;}
  .right-add24 { position:absolute; top:25%; right:0; width:10%; z-index:99999; height:60px;}
