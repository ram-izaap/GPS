...
//        }
       ...
       // map.setOptions({'scrollwheel': false});
        ...
        var filters    = '',filters1 ='',inv_pt='' ,groupname = '', infoindexx = '', partcipanthead = '', clues = '', markericon='';
  ...
  function user_position_save(user_id){
      ...
      var latlon = $("#latlang").val();
        ...
        $.post('<?php echo site_url();?>/home/user_position_save/'+user_id+'/'+res[0]+'/'+res[1], {}, function(response){
            ...
            if(srchkey!=''){
                $.post('<?php echo site_url();?>/home/search/'+srchkey+'/1', {}, function(resp){            
                    if(resp!=''){
                        resp = JSON.parse(resp);
                        map_search(resp.locations,resp.contents,resp.user_id,0);
                    }
                });
            }              
