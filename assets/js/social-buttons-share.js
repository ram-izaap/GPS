  ...
  $.fn.socialButtonsShare = function(customOptions, customSocialNetworks) {
    ...
    that.socialNetworks = {
      facebook: {
        ...
        shareurl: "https://www.facebook.com/sharer/sharer.php?u=" + that.options.url + "&p[summary]=" + that.options.text+"&p[url]="+that.options.url,
        height: 600,
        width: 600
      },
      twitter: {
        ...
        shareurl: "https://twitter.com/intent/tweet?text=View my location @ "+that.options.url+" Or you can search for my ID on the HeresMyGPS.com website",
        height: 600,
        width: 600
      },
      googleplus: {
      ...
      pinterest:{
        ...
        shareurl: 'https://pinterest.com/pin/create/button?url=' + that.options.url +"&description=" + that.options.text,
        height: 600,
        width: 600
      },
    /*  tumblr:{
    ...
    if (that.options.socialNetworks.length>0) {
      ...
      var htmlUl = "<ul" + classVertical + "></ul>";
